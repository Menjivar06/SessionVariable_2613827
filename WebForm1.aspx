<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="SessionVariable_2613827.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:TextBox ID="txtDescription" runat="server" Height="47px" TextMode="MultiLine" ></asp:TextBox>
     </p>
